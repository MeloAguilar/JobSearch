...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Usuario p4 = new Empresa ("Flores Pepi", "Floristeria", "FloresMari", "Rosita",15000);
        ...
        p4.seguirUsuario (p3);
         ...
         ((Profesional) p1).enviarSolicitud((Empresa)p3, "Cocino bien");
        ((Profesional) p2).enviarSolicitud ((Empresa) p3,"No se hace na");
        p3.seguirUsuario (p1);
        p3.seguirUsuario (p2);
        p3.seguirUsuario (p4);
